                                ...
                                <div class="flex items-center mt-2">
                                    @if(auth()->user()->avatar)
                                        <img src="{{ asset('storage/' . auth()->user()->avatar) }}" 
                                             class="h-16 w-16 rounded-full object-cover mr-4 border-2 border-indigo-200">
                                    @else
                                        <div class="h-16 w-16 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center text-2xl font-bold text-gray-500 dark:text-gray-300 mr-4">
